...
class DomainService {
  ...
  static const mainEndpoint = 'https://bamain.caige.origin55.com';
  static const authEndpoint = 'https://baauth.caige.origin55.com';
  static const dataEndpoint = 'https://badata.caige.origin55.com';
}